 ...
 * @author OLIDAN
 */
public abstract class Transactiondetails implements EntityBean {
    ...
    public abstract String getTransdid();

    public abstract void setTransdid(String transdid);
    ...
    public abstract Double getItemrate();

    public abstract void setItemrate(Double itemrate);
